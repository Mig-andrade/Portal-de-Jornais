	...
	switch(dia){
		...
		do {
			...
			if(jornal == 1){
				...
				printf("|Mat√©ria 1. ApÛs dia de caos, veja como est· circulaÁ„o de BRTs, Ùnibus e trens no Rio                                               |\n");
				printf("|Mat√©ria 2. Dia do Macarr„o: do cl·ssico repaginado ao contempor‚neo, veja uma seleÁ„o de receitas para saborear no Rio e em NiterÛi |\n");
				printf("|-------------------------------------------------------------------------------------------------------------------------------------|\n");
				printf("|Digite a mat√©ria que deseja ver:                                                                                                    |\n");
				...
				system ("cls");
					if(materia == 1){
						exibirMateria("ApÛs dia de caos, veja como est· circulaÁ„o de BRTs, Ùnibus e trens no Rio\n\n");
						printf("\tNa manh„ seguinte ao caos promovido por milicianos na Zona Oeste do Rio, quando 35 Ùnibus e um trem foram incendiados, os cariocas enfrentam uma manh„ ainda com resquÌcios do que foi provocado pelo rastro de destruiÁ„o.");
						printf ("Paes afirmou que, mesmo com os ataques a cinco estaÁıes do BRT, todas as estaÁıes est„o operando, exceto a Vendas de Varanda, que precisar· ter componente estruturais trocados. A liberaÁ„o deve ocorrer em uma semana.\n\n");
						printf ("De acordo com Paes, Transoeste e Ces·rio operam, mas o maior problema È com relaÁ„o aos 'diretıes'.\n\n");
						printf ("'A gente est· com a Transoeste circulando bem desde as primeiras horas do dia, com as deficiÍncias que ela ainda tem antes que a gente consiga entrar com os Ùnibus novos ali. A operaÁ„o dos 'diretıes' atrasou hoje', disse em postagem em rede social.\n\n");
						printf ("O miliciano Faust„o, sobrinho de Zinho, chefe de grupo militar que atua na Zona Oeste, foi morto em aÁ„o da PolÌcia Civil no Rio. Em repres·lia, 35 Ùnibus, um trem, uma estaÁ„o do BRT e quatro caminhıes e foram incendiados. \n\n");
						printf ("Os ataques ao sistema de transporte ocorreram enquanto o governador Cl·udio Castro parabenizava a polÌcia pela aÁ„o que resultou na morte do criminoso. Horas depois, Castro afirmou que a polÌcia n„o descansar· enquanto n„o prender os milicianos Zinho e Tandera e o traficante Abelha.\n\n");
						printf ("A milÌcia respons·vel por caos no Rio foi fundada por policiais, expandiu-se pelo estado na ˙ltima dÈcada e vive crise interna apÛs morte de ex-chefe.\n\n");
						printf ("Por causa dos impactos gerados pela onda de violÍncia, a SuperVia realiza uma manutenÁ„o no ramal de Santa Cruz. Por isso, no trecho entre Central do Brasil e Campo Grande est· com intervalos de cerca de 20 minutos. J· entre Campo Grande e Santa Cruz, o intervalo È de 40 minutos. Alguns trens para Santa Cruz est„o terminando a viagem na estaÁ„o de Campo Grande. A SuperVia afirma que 'lamenta o transtorno e trabalha para o r·pido restabelecimento da operaÁ„o.\n\n");
						printf ("O prefeito Eduardo Paes afirmou que a operaÁ„o comeÁa a normalizar na Zona Oeste. De acordo com ele, os primeiros Ùnibus j· seguiram para Santa Cruz, com linhas com destino ao Centro e ao metrÙ Coelho Neto.\n\n");
						printf ("A ViaÁ„o PÈgaso, porÈm, ainda n„o liberou Ùnibus para circularem, segundo Paes. Apenas coletivos do tipo fresc„o est„o em operaÁ„o. As ·reas mais afetadas s„o o lado norte de Campo Grande, Cosmos, InhoaÌba, PaciÍncia e Santa Cruz.\n\n");
						printf ("Segundo Paes, a circulaÁ„o dos Ùnibus normais no inÌcio da manh„ era de 50% da frota, mas por volta de 7h30 j· era de 80%.\n\n");
						printf ("¿s 8h45 desta terÁa, o municÌpio do Rio voltou ao est·gio de normalidade, apÛs o serviÁo de BRT ser regularizado. A cidade estava em est·gio de mobilizaÁ„o desde as 23h15 de segunda por causa dos ataques contra os Ùnibus e um trem.\n\n");
						printf("\n\nDigite 1 para voltar e 0 para sair: \n");
						scanf("%d", &jornal);
					}
					if(materia == 2){
						exibirMateria("Dia do Macarr„o: do cl·ssico repaginado ao contempor‚neo, veja uma seleÁ„o de receitas para saborear no Rio e em NiterÛi \n\n");
						printf("Onde o macarr„o surgiu n„o se sabe ao certo, mas o fato È que a It·lia deu uma grande contribuiÁ„o para a histÛria da massa ao criar e aprimorar diferentes tipos da pasta, que rompeu fronteiras e È hoje um dos alimentos mais apreciados no mundo. O que n„o falta È opÁ„o para celebrar o Dia Mundial do Macarr„o, comemorado nesta quarta-feira (25), incluindo restaurantes tradicionais italianos, contempor‚neos e lusitanos. Selecionamos sugestıes em restaurantes do Rio e de NiterÛi. \n\n");
						printf ("Um dos alimentos mais tracionais e afetivos do planeta, o macarr„o ganhou uma data para chamar de sua em 1995, quando ocorreu o primeiro Congresso Mundial da Pasta, em Roma, na It·lia, reunindo os principais fabricantes do mundo. No Brasil, a merecida comemoraÁ„o comeÁou em 2014.\n\n");
						printf ("Espaguete, linguine, penne, fettuccineÖ H· uma variaÁ„o deles. AlÈm dos diferentes tipos de preparo da massa. Servido em diferentes formatos, com proteÌnas ou n„o, o prato agrada a adultos e crianÁas mais exigentes. Cai bem com molhos variados ou como acompanhamento b·sico para carnes, peixes e vegetais.\n\n");
						printf("\n\nDigite 1 para voltar e 0 para sair: \n");
						scanf("%d", &jornal);
					}
